    ...
    <Container fluid style={{
        ...
        <Row style={{
            ...
            <Col xs={5} style={{
                ...
                <div>
                    <svg  width="50" height="50" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
        ...
        <Row>
            ...
            <div>
                ...
                <svg style={{
                    marginLeft:'15px'
                }}   fill="white" height="30px" width="30px" version="1.1" id="Layer_1" viewBox="0 0 310 310" >
                    <g id="XMLID_834_">
                ...
                <svg style={{
                    marginLeft:'15px'
                }}  x="0px" y="0px" height="35px" width="35px" fill="white" viewBox="0 0 50 50">
                ...
                <svg style={{
                    marginLeft:'15px'
                }}  x="0px" y="0px" height="45px" width="45px" fill="white" viewBox="0 0 50 50">
